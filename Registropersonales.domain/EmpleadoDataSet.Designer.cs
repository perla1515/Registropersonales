...
namespace Registropersonales.domain {
    ...
    public partial class EmpleadoDataSet : global::System.Data.DataSet {
        ...
        public partial class EmpleadoDataTable : global::System.Data.TypedTableBase<EmpleadoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmpleadoRow AddEmpleadoRow(string Nombre, string Apellido, long Cedula, int Edad, string Sexo) {
        ...
        public partial class EmpleadoRow : global::System.Data.DataRow {
            ...
            public long Cedula {
                get {
                    return ((long)(this[this.tableEmpleado.CedulaColumn]));
                }
                set {
...
namespace Registropersonales.domain.EmpleadoDataSetTableAdapters {
    ...
    public partial class EmpleadoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Empleado] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ([Apellido] = @Original_Apellido) AND ([Cedula] = @Original_Cedula) AND ((@IsNull_Edad = 1 AND [Edad] IS NULL) OR ([Edad] = @Original_Edad)) AND ([Sexo] = @Original_Sexo))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Empleado] ([Nombre], [Apellido], [Cedula], [Edad], [Sexo]) VAL" +
                "UES (@Nombre, @Apellido, @Cedula, @Edad, @Sexo);\r\nSELECT Id, Nombre, Apellido, C" +
                "edula, Edad, Sexo FROM Empleado WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Empleado] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [Cedula] = @Cedula, [Edad] = @Edad, [Sexo] = @Sexo WHERE (([Id] = @Original_Id) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ([Apellido] = @Original_Apellido) AND ([Cedula] = @Original_Cedula) AND ((@IsNull_Edad = 1 AND [Edad] IS NULL) OR ([Edad] = @Original_Edad)) AND ([Sexo] = @Original_Sexo));
SELECT Id, Nombre, Apellido, Cedula, Edad, Sexo FROM Empleado WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Registropersonales.domain.Properties.Settings.Default.EMPLEADO;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nombre, Apellido, Cedula, Edad, Sexo FROM dbo.Empleado";
        ...
        public virtual int Fill(EmpleadoDataSet.EmpleadoDataTable dataTable) {
        ...
        public virtual EmpleadoDataSet.EmpleadoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EmpleadoDataSet.EmpleadoDataTable dataTable = new EmpleadoDataSet.EmpleadoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EmpleadoDataSet.EmpleadoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nombre, string Original_Apellido, long Original_Cedula, global::System.Nullable<int> Original_Edad, string Original_Sexo) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((long)(Original_Cedula));
        ...
        public virtual int Insert(string Nombre, string Apellido, long Cedula, global::System.Nullable<int> Edad, string Sexo) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Apellido, long Cedula, global::System.Nullable<int> Edad, string Sexo, int Original_Id, string Original_Nombre, string Original_Apellido, long Original_Cedula, global::System.Nullable<int> Original_Edad, string Original_Sexo, int Id) {
            if ((Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellido, long Cedula, global::System.Nullable<int> Edad, string Sexo, int Original_Id, string Original_Nombre, string Original_Apellido, long Original_Cedula, global::System.Nullable<int> Original_Edad, string Original_Sexo) {
            return this.Update(Nombre, Apellido, Cedula, Edad, Sexo, Original_Id, Original_Nombre, Original_Apellido, Original_Cedula, Original_Edad, Original_Sexo, Original_Id);
        }
    }
